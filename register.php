...
if (isset($_POST['submit'])) {
   ...
   if ($select_user->rowCount() > 0) {
      ...
      if ($pass != $cpass) {
         $message[] = 'Confirmation non identique!';
      } else {
        ...
        <form class="register" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex">
                ...
                <div class="col">
                    ...
                    <input type="password" name="cpass" placeholder="Confirmer le mot de passe" maxlength="20" required
                        class="box">
                </div>
            </div>
            <p>Sectionner un image <span>*</span></p>
            <input type="file" name="image" accept="image/*" required class="box">
            <p class="link">Vous avez un compte? <a href="login.php">Connectez-vous</a></p>
