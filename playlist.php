...
if(isset($_POST['save_list'])){
   ...
   if($user_id != ''){
      ...
      $message[] = "S'ils vous plaît faites votre premiere connection!";
   }
...
<body>
      ...
      ?>
            ...
            ?>
                    <button type="submit" name="save_list"><i
                            class="fas fa-bookmark"></i><span>Sauvegardé</span></button>
                    <?php
               }else{
            ?>
                    <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>Sauvegardé votre
            ...
            echo '<p class="empty">Playlist introuvable!</p>';
         }  
      ?>
    ...
    <section class="videos-container">
      ...
      ?>
            ...
            echo '<p class="empty">Pas de video ajoutées!</p>';
         }
      ?>
