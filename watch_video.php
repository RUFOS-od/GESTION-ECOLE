   ...
   if($user_id != ''){
      ...
      if($select_content->rowCount() > 0){
         ...
         if($select_comment->rowCount() > 0){
            $message[] = 'Commantaire bien ajouté!';
         }else{
         ...
         $message[] = 'Attention quelque chose ne va pas!';
      }
...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Commentaire supprimer avec succes!';
   }else{
      $message[] = 'commenetaire supprimer!';
   }
...
if(isset($_POST['update_now'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Commntaire édité avec succes!';
   }
...
?>
    <section class="edit-comment">
        <h1 class="heading">Commnenter</h1>
        <form action="" method="post">
            <input type="hidden" name="update_id" value="<?= $fetch_edit_comment['id']; ?>">
            <textarea name="update_box" class="box" maxlength="1000" required placeholder="Entrer votre commentaire"
                cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
            <div class="flex">
                <a href="watch_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">Abandonner</a>
                <input type="submit" value="Envoyer maintenant name=" update_now" class="inline-btn">
            </div>
        </form>
    </section>
    <?php
   }else{
      $message[] = 'Commentaire pas trouver !';
   }
}
?>
   ...
   ?>
        ...
        <?php
         ...
         echo '<p class="empty">Aucune vidéo ajoutée!</p>';
      }
   ?>
    ...
    <section class="comments">
        ...
        <h1 class="heading">Ajouter un nouveau commentaire</h1>
      ...
      ?>
         ...
         ?>
                <form action="" method="post" class="flex-btn">
                    ...
                    <button type="submit" name="delete_comment" class="inline-delete-btn"
                        onclick="return confirm('delete this comment?');">supprimer comment</button>
                </form>
                <?php
         }
         ?>
         ...
         echo '<p class="empty">Pas de commentaire ajouté!</p>';
      }
      ?>
        </div>
