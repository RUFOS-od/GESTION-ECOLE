...
<body>
   ...
   ?>
    <section class="edit-comment">
        <h1 class="heading">commentaire édité</h1>
        <form action="" method="post">
            <input type="hidden" name="update_id" value="<?= $fetch_edit_comment['id']; ?>">
            <textarea name="update_box" class="box" maxlength="1000" required
                placeholder="veuillez saisir votre commentaire" cols="30"
                rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
            <div class="flex">
    ...
    <section class="comments">
        ...
        <div class="show-comments">
         ...
         ?>
            <div class="box" style="<?php if ($fetch_comment['user_id'] == $user_id) {
                ...
                <div class="content"><span><?= $fetch_comment['date']; ?></span>
                    <p> - <?= $fetch_content['title']; ?> - </p><a
                        href="watch_video.php?get_id=<?= $fetch_content['id']; ?>">Voir le contenu</a>
                </div>
                ...
                <form action="" method="post" class="flex-btn">
                    ...
                    <button type="submit" name="edit_comment" class="inline-option-btn">éditer un commentaire</button>
                    <button type="submit" name="delete_comment" class="inline-delete-btn"
                        onclick="return confirm('delete this comment?');">supprimer le commentaire</button>
                </form>
                <?php
                  }
                  ?>
            ...
            echo '<p class="empty">aucun commentaire n\'a encore été ajouté !</p>';
         }
         ?>
        </div>
