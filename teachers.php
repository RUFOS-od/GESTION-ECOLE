...
<body>
    ...
    <section class="teachers">
        ...
        <form action="search_tutor.php" method="post" class="search-tutor">
            <input type="text" name="search_tutor" maxlength="100" placeholder="rechercher un tuteur..." required>
      ...
      ?>
            <div class="box">
                ...
                <form action="tutor_profile.php" method="post">
                    ...
                    <input type="submit" value="Voir Profil" name="tutor_fetch" class="inline-btn">
                </form>
            </div>
            <?php
            }
